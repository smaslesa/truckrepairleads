...
import { ArrowRight, Clock, Shield, Smartphone, Star, TrendingUp, Users, Wrench, CheckCircle2 } from 'lucide-react'
import LeadModal from '@/components/shared/LeadModal'

const WebsiteDemoSection = () => {
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-20">
            <div className="text-center mb-16">
              ...
              <h2 className="text-5xl sm:text-6xl font-bold text-gray-900 mb-8 leading-[1.05] tracking-tight">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <a
                  href="tel:7029000265"
                  className="text-gray-700 hover:text-gray-900 px-8 py-4 rounded-xl font-semibold text-lg transition-all hover:bg-white"
                >
                  Call (702) 900-0265
                </a>
              </div>
            ...
            {/* Browser Mockup with Key Features */}
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
              ...
              <p className="text-gray-600 leading-relaxed">
                Built on global edge infrastructure for instant page loads. Your customers never wait, and Google rewards speed with higher rankings.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
              ...
              <p className="text-gray-600 leading-relaxed">
                SSL encryption, DDoS protection, and automatic security updates. Your site and customer data stay protected 24/7.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
              ...
              <h3 className="font-bold text-gray-900 text-lg mb-2">Mobile First</h3>
              <p className="text-gray-600 leading-relaxed">
                78% of truck repair searches happen on mobile. Your site looks perfect on every device—phone, tablet, or desktop.
              </p>
            </div>
          </div>
        </div>
...
export default WebsiteDemoSection
